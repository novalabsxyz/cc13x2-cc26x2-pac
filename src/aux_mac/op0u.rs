...
#[doc = r" Proxy"]
pub struct _OP0_VALUEW<'a> {
    w: &'a mut W,
}
impl<'a> _OP0_VALUEW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u16) -> &'a mut W {
        const MASK: u16 = 65535;
...
impl R {
    ...
    #[doc = "Bits 0:15 - 15:0\\] Unsigned operand 0. Operand for multiply, multiply-and-accumulate, or 32-bit add operations."]
    #[inline]
    pub fn op0_value(&self) -> OP0_VALUER {
        let bits = {
            const MASK: u16 = 65535;
            const OFFSET: u8 = 0;
            ((self.bits >> OFFSET) & MASK as u32) as u16
...
impl W {
    ...
    #[doc = "Bits 0:15 - 15:0\\] Unsigned operand 0. Operand for multiply, multiply-and-accumulate, or 32-bit add operations."]
    #[inline]
    pub fn op0_value(&mut self) -> _OP0_VALUEW {
        _OP0_VALUEW { w: self }
    }
}
