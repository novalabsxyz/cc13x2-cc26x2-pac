...
impl R {
    ...
    #[doc = "Bits 0:23 - 23:0\\] Parity Error Address Offset Returns the last address offset which resulted in a parity error during an SRAM read."]
    #[inline]
    pub fn per_addr(&self) -> PER_ADDRR {
        let bits = {
            const MASK: u32 = 16777215;
            const OFFSET: u8 = 0;
...
impl W {
    ...
    #[doc = "Bits 0:23 - 23:0\\] Parity Error Address Offset Returns the last address offset which resulted in a parity error during an SRAM read."]
    #[inline]
    pub fn per_addr(&mut self) -> _PER_ADDRW {
        _PER_ADDRW { w: self }
    }
}
