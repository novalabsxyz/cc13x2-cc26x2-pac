...
impl R {
    ...
    #[doc = "Bits 0:23 - 23:0\\] Debug Parity Error Address Offset When PER_CTL:PER_DEBUG is 1, this field is used to set an address offset so that writes to this address offset followed by reads from within this address offset will result in parity errors."]
    #[inline]
