...
impl R {
    ...
    #[doc = "Bit 12 - 12:12\\] Interrupt flag 12. IEEE 802.15.4 mode only: A background level radio operation command has been suspended. Write zero to clear flag. Write to one has no effect."]
    #[inline]
