...
#[doc = "Possible values of the field `BG_COMMAND_SUSPENDED`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum BG_COMMAND_SUSPENDEDR {
    #[doc = "Associate this interrupt line with INT_RF_CPE1 interrupt vector"]
    CPE1,
    #[doc = "Associate this interrupt line with INT_RF_CPE0 interrupt vector"]
    CPE0,
...
impl BG_COMMAND_SUSPENDEDR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            BG_COMMAND_SUSPENDEDR::CPE1 => true,
            BG_COMMAND_SUSPENDEDR::CPE0 => false,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> BG_COMMAND_SUSPENDEDR {
        match value {
            true => BG_COMMAND_SUSPENDEDR::CPE1,
            false => BG_COMMAND_SUSPENDEDR::CPE0,
        }
    }
    #[doc = "Checks if the value of the field is `CPE1`"]
    #[inline]
    pub fn is_cpe1(&self) -> bool {
        *self == BG_COMMAND_SUSPENDEDR::CPE1
    }
    #[doc = "Checks if the value of the field is `CPE0`"]
    #[inline]
    pub fn is_cpe0(&self) -> bool {
        *self == BG_COMMAND_SUSPENDEDR::CPE0
    }
}
...
#[doc = "Values that can be written to the field `BG_COMMAND_SUSPENDED`"]
pub enum BG_COMMAND_SUSPENDEDW {
    #[doc = "Associate this interrupt line with INT_RF_CPE1 interrupt vector"]
    CPE1,
    #[doc = "Associate this interrupt line with INT_RF_CPE0 interrupt vector"]
    CPE0,
}
impl BG_COMMAND_SUSPENDEDW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _bits(&self) -> bool {
        match *self {
            BG_COMMAND_SUSPENDEDW::CPE1 => true,
            BG_COMMAND_SUSPENDEDW::CPE0 => false,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _BG_COMMAND_SUSPENDEDW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: BG_COMMAND_SUSPENDEDW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn cpe1(self) -> &'a mut W {
        self.variant(BG_COMMAND_SUSPENDEDW::CPE1)
    }
    #[doc = "Associate this interrupt line with INT_RF_CPE0 interrupt vector"]
    #[inline]
    pub fn cpe0(self) -> &'a mut W {
        self.variant(BG_COMMAND_SUSPENDEDW::CPE0)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    #[doc = "Bit 12 - 12:12\\] Select which CPU interrupt vector the RFCPEIFG.BG_COMMAND_SUSPENDED interrupt should use."]
    #[inline]
    pub fn bg_command_suspended(&self) -> BG_COMMAND_SUSPENDEDR {
        BG_COMMAND_SUSPENDEDR::_from({
            const MASK: bool = true;
            const OFFSET: u8 = 12;
            ((self.bits >> OFFSET) & MASK as u32) != 0
        })
