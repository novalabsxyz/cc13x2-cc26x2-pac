...
impl W {
    ...
    #[doc = "Bits 24:31 - 31:24\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn pump_su(&mut self) -> _PUMP_SUW {
        _PUMP_SUW { w: self }
    }
    #[doc = "Bits 16:23 - 23:16\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn trim3p4(&mut self) -> _TRIM3P4W {
        _TRIM3P4W { w: self }
    }
    #[doc = "Bits 0:15 - 15:0\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn max_pp(&mut self) -> _MAX_PPW {
        _MAX_PPW { w: self }
    }
}
