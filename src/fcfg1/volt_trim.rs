...
#[doc = r" Proxy"]
pub struct _VDDR_TRIM_HHW<'a> {
    w: &'a mut W,
}
impl<'a> _VDDR_TRIM_HHW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
        const MASK: u8 = 31;
...
#[doc = r" Proxy"]
pub struct _VDDR_TRIM_HW<'a> {
    w: &'a mut W,
}
impl<'a> _VDDR_TRIM_HW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
        const MASK: u8 = 31;
...
#[doc = r" Proxy"]
pub struct _VDDR_TRIM_SLEEP_HW<'a> {
    w: &'a mut W,
}
impl<'a> _VDDR_TRIM_SLEEP_HW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
        const MASK: u8 = 31;
...
impl W {
    ...
    #[doc = "Bits 24:28 - 28:24\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn vddr_trim_hh(&mut self) -> _VDDR_TRIM_HHW {
        _VDDR_TRIM_HHW { w: self }
    }
    #[doc = "Bits 21:23 - 23:21\\] Internal. Only to be used through TI provided API."]
    #[inline]
    ...
    #[doc = "Bits 16:20 - 20:16\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn vddr_trim_h(&mut self) -> _VDDR_TRIM_HW {
        _VDDR_TRIM_HW { w: self }
    }
    #[doc = "Bits 13:15 - 15:13\\] Internal. Only to be used through TI provided API."]
    #[inline]
    ...
    #[doc = "Bits 8:12 - 12:8\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn vddr_trim_sleep_h(&mut self) -> _VDDR_TRIM_SLEEP_HW {
        _VDDR_TRIM_SLEEP_HW { w: self }
    }
    #[doc = "Bits 5:7 - 7:5\\] Internal. Only to be used through TI provided API."]
    #[inline]
    ...
    #[doc = "Bits 0:4 - 4:0\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn trimbod_h(&mut self) -> _TRIMBOD_HW {
        _TRIMBOD_HW { w: self }
    }
}
