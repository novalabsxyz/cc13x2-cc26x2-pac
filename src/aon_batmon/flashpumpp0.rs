...
#[doc = r" Value of the field"]
pub struct DIS_NOISE_FILTERR {
    bits: bool,
}
impl DIS_NOISE_FILTERR {
    #[doc = r" Value of the field as raw bits"]
    #[inline]
...
#[doc = r" Proxy"]
pub struct _DIS_NOISE_FILTERW<'a> {
    w: &'a mut W,
}
impl<'a> _DIS_NOISE_FILTERW<'a> {
...
impl R {
    ...
    #[inline]
    pub fn dis_noise_filter(&self) -> DIS_NOISE_FILTERR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 9;
            ((self.bits >> OFFSET) & MASK as u32) != 0
        };
        DIS_NOISE_FILTERR { bits }
    }
...
impl W {
    ...
    #[doc = "Bit 9 - 9:9\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn dis_noise_filter(&mut self) -> _DIS_NOISE_FILTERW {
        _DIS_NOISE_FILTERW { w: self }
    }
    #[doc = "Bit 8 - 8:8\\] Internal. Only to be used through TI provided API."]
    #[inline]
