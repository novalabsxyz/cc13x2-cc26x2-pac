...
impl R {
    ...
    #[doc = "Bit 15 - 15:15\\] EVTOMCUFLAGS.AUX_TIMER2_PULSE contribution to the AUX_COMB event. 0: Exclude. 1: Include."]
    #[inline]
    ...
    #[doc = "Bit 14 - 14:14\\] EVTOMCUFLAGS.AUX_TIMER2_EV3 contribution to the AUX_COMB event. 0: Exclude. 1: Include."]
    #[inline]
    ...
    #[doc = "Bit 13 - 13:13\\] EVTOMCUFLAGS.AUX_TIMER2_EV2 contribution to the AUX_COMB event. 0: Exclude. 1: Include."]
    #[inline]
    ...
    #[doc = "Bit 12 - 12:12\\] EVTOMCUFLAGS.AUX_TIMER2_EV1 contribution to the AUX_COMB event. 0: Exclude. 1: Include."]
    #[inline]
    ...
    #[doc = "Bit 11 - 11:11\\] EVTOMCUFLAGS.AUX_TIMER2_EV0 contribution to the AUX_COMB event. 0: Exclude. 1: Include."]
    #[inline]
    ...
    #[doc = "Bit 10 - 10:10\\] EVTOMCUFLAGS.AUX_ADC_IRQ contribution to the AUX_COMB event. 0: Exclude. 1: Include."]
    #[inline]
    ...
    #[doc = "Bit 8 - 8:8\\] EVTOMCUFLAGS.AUX_ADC_FIFO_ALMOST_FULL contribution to the AUX_COMB event. 0: Exclude. 1: Include."]
    #[inline]
    ...
    #[doc = "Bit 7 - 7:7\\] EVTOMCUFLAGS.AUX_ADC_DONE contribution to the AUX_COMB event. 0: Exclude. 1: Include."]
    #[inline]
    ...
    #[doc = "Bit 6 - 6:6\\] EVTOMCUFLAGS.AUX_SMPH_AUTOTAKE_DONE contribution to the AUX_COMB event. 0: Exclude. 1: Include."]
    #[inline]
    ...
    #[doc = "Bit 5 - 5:5\\] EVTOMCUFLAGS.AUX_TIMER1_EV contribution to the AUX_COMB event. 0: Exclude. 1: Include."]
    #[inline]
    ...
    #[doc = "Bit 4 - 4:4\\] EVTOMCUFLAGS.AUX_TIMER0_EV contribution to the AUX_COMB event. 0: Exclude. 1: Include."]
    #[inline]
    ...
    #[doc = "Bit 3 - 3:3\\] EVTOMCUFLAGS.AUX_TDC_DONE contribution to the AUX_COMB event. 0: Exclude. 1: Include."]
    #[inline]
    ...
    #[doc = "Bit 0 - 0:0\\] EVTOMCUFLAGS.AUX_WU_EV contribution to the AUX_COMB event. 0: Exclude. 1: Include."]
    #[inline]
