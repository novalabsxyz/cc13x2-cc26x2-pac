...
impl SELR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            SELR::AUX_ADC_FIFO_ALMOST_FULL => true,
            SELR::AUX_ADC_FIFO_NOT_EMPTY => false,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
...
impl SELW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            SELW::AUX_ADC_FIFO_ALMOST_FULL => true,
            SELW::AUX_ADC_FIFO_NOT_EMPTY => false,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _SELW<'a> {
    ...
    pub fn aux_adc_fifo_almost_full(self) -> &'a mut W {
        self.variant(SELW::AUX_ADC_FIFO_ALMOST_FULL)
    }
    #[doc = "UDMA0 trigger event will be generated when there are samples in the ADC FIFO."]
    #[inline]
    pub fn aux_adc_fifo_not_empty(self) -> &'a mut W {
        self.variant(SELW::AUX_ADC_FIFO_NOT_EMPTY)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
