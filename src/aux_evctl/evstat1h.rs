...
impl R {
    ...
    #[doc = "Bits 0:7 - 7:0\\] Alias of EVSTAT1 event 15 down to 8."]
    #[inline]
    pub fn alias_ev(&self) -> ALIAS_EVR {
        let bits = {
            const MASK: u8 = 255;
            const OFFSET: u8 = 0;
...
impl W {
    ...
    #[doc = "Bits 0:7 - 7:0\\] Alias of EVSTAT1 event 15 down to 8."]
    #[inline]
    pub fn alias_ev(&mut self) -> _ALIAS_EVW {
        _ALIAS_EVW { w: self }
    }
}
