...
#[doc = r" Value of the field"]
pub struct PWRPROF_TAP_ENABLER {
    bits: u8,
}
impl PWRPROF_TAP_ENABLER {
    #[doc = r" Value of the field as raw bits"]
    #[inline]
    pub fn bits(&self) -> u8 {
        self.bits
...
#[doc = r" Proxy"]
pub struct _PWRPROF_TAP_ENABLEW<'a> {
    w: &'a mut W,
}
impl<'a> _PWRPROF_TAP_ENABLEW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
        const MASK: u8 = 255;
...
impl R {
    ...
    #[doc = "Bits 8:15 - 15:8\\] Enable PWRPROF TAP. 0xC5: PWRPROF TAP access is enabled during power-up/system-reset by ROM boot FW if enabled by corresponding configuration value in FCFG1 defined by TI. Any other value: PWRPROF TAP access will remain disabled out of power-up/system-reset."]
    #[inline]
    pub fn pwrprof_tap_enable(&self) -> PWRPROF_TAP_ENABLER {
        let bits = {
            const MASK: u8 = 255;
            const OFFSET: u8 = 8;
            ((self.bits >> OFFSET) & MASK as u32) as u8
        };
        PWRPROF_TAP_ENABLER { bits }
    }
...
impl W {
    ...
    #[doc = "Bits 8:15 - 15:8\\] Enable PWRPROF TAP. 0xC5: PWRPROF TAP access is enabled during power-up/system-reset by ROM boot FW if enabled by corresponding configuration value in FCFG1 defined by TI. Any other value: PWRPROF TAP access will remain disabled out of power-up/system-reset."]
    #[inline]
    pub fn pwrprof_tap_enable(&mut self) -> _PWRPROF_TAP_ENABLEW {
        _PWRPROF_TAP_ENABLEW { w: self }
    }
    #[doc = "Bits 0:7 - 7:0\\] Enable Test TAP. 0xC5: TEST TAP access is enabled during power-up/system-reset by ROM boot FW if enabled by corresponding configuration value in FCFG1 defined by TI. Any other value: TEST TAP access will remain disabled out of power-up/system-reset."]
    #[inline]
