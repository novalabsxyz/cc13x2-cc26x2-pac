...
impl W {
    ...
    #[doc = "Bit 17 - 17:17\\] Reflects possible transfer errors on the AHB port."]
    #[inline]
    pub fn port_err(&mut self) -> _PORT_ERRW {
        _PORT_ERRW { w: self }
    }
    #[doc = "Bits 2:16 - 16:2\\] Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline]
    ...
    #[doc = "Bit 1 - 1:1\\] A value of 1 indicates that channel 1 is active (DMA transfer on-going)."]
    #[inline]
    pub fn ch1_act(&mut self) -> _CH1_ACTW {
        _CH1_ACTW { w: self }
    }
    #[doc = "Bit 0 - 0:0\\] A value of 1 indicates that channel 0 is active (DMA transfer on-going)."]
    #[inline]
    pub fn ch0_act(&mut self) -> _CH0_ACTW {
        _CH0_ACTW { w: self }
    }
}
