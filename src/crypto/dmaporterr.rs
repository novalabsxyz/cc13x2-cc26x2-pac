...
#[doc = r" Value of the field"]
pub struct PORT1_AHB_ERRORR {
    bits: bool,
}
impl PORT1_AHB_ERRORR {
    #[doc = r" Value of the field as raw bits"]
    #[inline]
...
#[doc = r" Proxy"]
pub struct _PORT1_AHB_ERRORW<'a> {
    w: &'a mut W,
}
impl<'a> _PORT1_AHB_ERRORW<'a> {
...
#[doc = r" Proxy"]
pub struct _PORT1_CHANNELW<'a> {
    w: &'a mut W,
}
impl<'a> _PORT1_CHANNELW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl R {
    ...
    #[inline]
    pub fn port1_ahb_error(&self) -> PORT1_AHB_ERRORR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 12;
            ((self.bits >> OFFSET) & MASK as u32) != 0
        };
        PORT1_AHB_ERRORR { bits }
    }
    ...
    #[inline]
    pub fn port1_channel(&self) -> PORT1_CHANNELR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 9;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[doc = "Bits 0:8 - 8:0\\] Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline]
...
impl W {
    ...
    #[doc = "Bit 12 - 12:12\\] A value of 1 indicates that the EIP-101 has detected an AHB bus error"]
    #[inline]
    pub fn port1_ahb_error(&mut self) -> _PORT1_AHB_ERRORW {
        _PORT1_AHB_ERRORW { w: self }
    }
    #[doc = "Bits 10:11 - 11:10\\] Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline]
    ...
    #[doc = "Bit 9 - 9:9\\] Indicates which channel has serviced last (channel 0 or channel 1) by AHB master port."]
    #[inline]
    pub fn port1_channel(&mut self) -> _PORT1_CHANNELW {
        _PORT1_CHANNELW { w: self }
    }
    #[doc = "Bits 0:8 - 8:0\\] Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline]
