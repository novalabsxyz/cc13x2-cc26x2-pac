...
impl<'a> _CLK_ENW<'a> {
    ...
    pub fn am_uart1(self) -> &'a mut W {
        self.variant(CLK_ENW::AM_UART1)
    }
    #[doc = "Enable clock for UART0"]
    #[inline]
    pub fn am_uart0(self) -> &'a mut W {
        self.variant(CLK_ENW::AM_UART0)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
...
impl R {
    ...
    #[doc = "Bits 0:1 - 1:0\\] 0: Disable clock 1: Enable clock Can be forced on by UARTCLKGR.AM_CLK_EN For changes to take effect, CLKLOADCTL.LOAD needs to be written"]
    #[inline]
