...
impl R {
    ...
    #[doc = "Bits 0:1 - 1:0\\] 00: Disable clock 01: Disable clock when SYSBUS clock is disabled 11: Enable clock For changes to take effect, CLKLOADCTL.LOAD needs to be written"]
    #[inline]
