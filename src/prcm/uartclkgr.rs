...
impl AM_CLK_ENR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            AM_CLK_ENR::AM_UART1 => 2,
            AM_CLK_ENR::AM_UART0 => 1,
    ...
    pub fn _from(value: u8) -> AM_CLK_ENR {
        match value {
            2 => AM_CLK_ENR::AM_UART1,
            1 => AM_CLK_ENR::AM_UART0,
...
impl AM_CLK_ENW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            AM_CLK_ENW::AM_UART1 => 2,
            AM_CLK_ENW::AM_UART0 => 1,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _AM_CLK_ENW<'a> {
    ...
    pub fn am_uart1(self) -> &'a mut W {
        self.variant(AM_CLK_ENW::AM_UART1)
    }
    #[doc = "Enable clock for UART0"]
    #[inline]
    pub fn am_uart0(self) -> &'a mut W {
        self.variant(AM_CLK_ENW::AM_UART0)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
...
impl<'a> _CLK_ENW<'a> {
    ...
    pub fn uart1(self) -> &'a mut W {
        self.variant(CLK_ENW::UART1)
    }
    #[doc = "Enable clock for UART0"]
    #[inline]
    pub fn uart0(self) -> &'a mut W {
        self.variant(CLK_ENW::UART0)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl R {
    ...
    #[doc = "Bits 8:9 - 9:8\\] 0: No force 1: Force clock on for all modes (Run, Sleep and Deep Sleep) Overrides CLK_EN, UARTCLKGS.CLK_EN and UARTCLKGDS.CLK_EN when enabled. For changes to take effect, CLKLOADCTL.LOAD needs to be written"]
    #[inline]
