...
impl R {
    ...
    #[doc = "Bit 3 - 3:3\\] 0: Retention for RFC ULL SRAM disabled 1: Retention for RFC ULL SRAM enabled Memories controlled: CPEULLRAM"]
    #[inline]
    ...
    #[doc = "Bit 2 - 2:2\\] 0: Retention for RFC SRAM disabled 1: Retention for RFC SRAM enabled Memories controlled: CPERAM MCERAM RFERAM DSBRAM"]
    #[inline]
...
impl W {
    ...
    #[doc = "Bit 3 - 3:3\\] 0: Retention for RFC ULL SRAM disabled 1: Retention for RFC ULL SRAM enabled Memories controlled: CPEULLRAM"]
    #[inline]
    pub fn rfcull(&mut self) -> _RFCULLW {
        _RFCULLW { w: self }
    }
    #[doc = "Bit 2 - 2:2\\] 0: Retention for RFC SRAM disabled 1: Retention for RFC SRAM enabled Memories controlled: CPERAM MCERAM RFERAM DSBRAM"]
    #[inline]
