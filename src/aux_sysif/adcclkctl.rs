...
impl R {
    ...
    #[doc = "Bit 1 - 1:1\\] Clock acknowledgement. 0: ADC clock is disabled. 1: ADC clock is enabled."]
    #[inline]
    ...
    #[doc = "Bit 0 - 0:0\\] ADC clock request. 0: Disable ADC clock. 1: Enable ADC clock. Only modify REQ when equal to ACK."]
    #[inline]
