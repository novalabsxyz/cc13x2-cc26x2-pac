...
impl R {
    ...
    #[doc = "Bit 1 - 1:1\\] TDC counter clock acknowledgement. 0: TDC counter clock is disabled. 1: TDC counter clock is enabled."]
    #[inline]
    ...
    #[doc = "Bit 0 - 0:0\\] TDC counter clock request. 0: Disable TDC counter clock. 1: Enable TDC counter clock. Only modify REQ when equal to ACK."]
    #[inline]
