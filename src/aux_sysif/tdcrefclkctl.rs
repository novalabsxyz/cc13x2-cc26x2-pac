...
impl R {
    ...
    #[doc = "Bit 1 - 1:1\\] TDC reference clock acknowledgement. 0: TDC reference clock is disabled. 1: TDC reference clock is enabled."]
    #[inline]
    ...
    #[doc = "Bit 0 - 0:0\\] TDC reference clock request. 0: Disable TDC reference clock. 1: Enable TDC reference clock. Only modify REQ when equal to ACK."]
    #[inline]
