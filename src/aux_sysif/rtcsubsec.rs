...
impl R {
    ...
    #[doc = "Bits 0:15 - 15:0\\] Bits 31:16 in AON_RTC:SUBSEC.VALUE. Follow this procedure to get the correct value: - Do two dummy reads SUBSEC. - Then read SUBSEC until two consecutive reads are equal."]
    #[inline]
...
impl W {
    ...
    #[doc = "Bits 0:15 - 15:0\\] Bits 31:16 in AON_RTC:SUBSEC.VALUE. Follow this procedure to get the correct value: - Do two dummy reads SUBSEC. - Then read SUBSEC until two consecutive reads are equal."]
    #[inline]
    pub fn subsec(&mut self) -> _SUBSECW {
        _SUBSECW { w: self }
    }
}
