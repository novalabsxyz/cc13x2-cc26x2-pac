...
impl R {
    ...
    #[doc = "Bit 7 - 7:7\\] Event 3 enable. 0: Channel 1 does not control event 3. 1: Channel 1 controls event 3. When 0 < CCACT < 8, EV3_GEN becomes zero after a capture or compare event."]
    #[inline]
    ...
    #[doc = "Bit 6 - 6:6\\] Event 2 enable. 0: Channel 1 does not control event 2. 1: Channel 1 controls event 2. When 0 < CCACT < 8, EV2_GEN becomes zero after a capture or compare event."]
    #[inline]
    ...
    #[doc = "Bit 5 - 5:5\\] Event 1 enable. 0: Channel 1 does not control event 1. 1: Channel 1 controls event 1. When 0 < CCACT < 8, EV1_GEN becomes zero after a capture or compare event."]
    #[inline]
    ...
    #[doc = "Bit 4 - 4:4\\] Event 0 enable. 0: Channel 1 does not control event 0. 1: Channel 1 controls event 0. When 0 < CCACT < 8, EV0_GEN becomes zero after a capture or compare event."]
    #[inline]
