...
impl R {
    ...
    #[doc = "Bit 0 - 0:0\\] Pulse trigger. Write 1 to generate a pulse to AUX_EVCTL:EVSTAT3.AUX_TIMER2_PULSE. Pulse width equals the duty cycle of AUX_SYSIF:TIMER2CLKCTL.SRC."]
    #[inline]
